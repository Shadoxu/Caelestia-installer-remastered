"""Emoji subcommand — fuzzel-based emoji / nerd-font glyph picker."""
...
def register_parser(subparsers) -> None:
    p = subparsers.add_parser("emoji", help="emoji/glyph utilities")
    p.set_defaults(cls=Command)
    p.add_argument("-p", "--picker", action="store_true", help="open the emoji/glyph picker")
    p.add_argument("-f", "--fetch",  action="store_true", help="fetch emoji/glyph data from remote")
