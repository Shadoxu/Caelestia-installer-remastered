"""Screenshot subcommand — capture the full screen or a user-selected region."""
...
def register_parser(subparsers) -> None:
    ...
    p.add_argument("-r", "--region", nargs="?", const="slurp",
                   help="take a screenshot of a region")
    p.add_argument("-f", "--freeze", action="store_true",
